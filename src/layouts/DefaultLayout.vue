...
import { version as vuexVersion } from "vuex/package.json";
...
<template>
  ...
  <footer>
    ...
    - by <a href="https://github.com/Oscar-Raygoza">@Oscar-Raygoza</a> 2022
    <br />
    Using Vue v{{ vueVersion }} and Vuex v{{ vuexVersion }}. Project Version:
    v{{ projectVersion }}
  </footer>
</template>
